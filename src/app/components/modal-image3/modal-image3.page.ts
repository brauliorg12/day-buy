...
@Component({
  selector: 'app-modal-image3',
  templateUrl: './modal-image3.page.html',
  styleUrls: ['./modal-image3.page.scss'],
})
export class ModalImage3Page implements OnInit {
  ...
  refresh() {
    this.refreshEvent.serviceFunction3();
  }
