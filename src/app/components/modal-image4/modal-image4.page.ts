...
@Component({
  selector: 'app-modal-image4',
  templateUrl: './modal-image4.page.html',
  styleUrls: ['./modal-image4.page.scss'],
})
export class ModalImage4Page implements OnInit {
  ...
  refresh() {
    this.refreshEvent.serviceFunction4();
  }
