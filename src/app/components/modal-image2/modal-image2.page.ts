...
@Component({
  selector: 'app-modal-image2',
  templateUrl: './modal-image2.page.html',
  styleUrls: ['./modal-image2.page.scss'],
})
export class ModalImage2Page implements OnInit {
  ...
  refresh() {
    this.refreshEvent.serviceFunction2();
  }
